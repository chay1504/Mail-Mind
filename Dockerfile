...
CMD ["sh", "-c", "n8n start & sleep 10; n8n import:workflow --input=/tmp/n8n-workflows/mailmind-scheduled-sync.json; n8n import:workflow --input=/tmp/n8n-workflows/mailmind-process-thread-webhook.json; wait"]
